  ...
  return (
    <DashboardLayout>
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold mb-6">About Hyper Dash</h1>
        <div className="space-y-6">
          <section>
            <h2 className="text-2xl font-semibold mb-3">What is Hyper Dash?</h2>
            <p className="text-muted-foreground">
              Hyper Dash is a powerful, user-friendly cryptocurrency dashboard that allows you to track, analyze, and
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-4">
              Hyper Dash is entirely API-based, pulling data directly from LiquidLaunch and other trusted sources. We
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-4">
              At Hyper Dash, we take your privacy seriously. Since we don't collect or store any personal data, you can
              use our platform with complete confidence.
            </p>
            <p className="text-muted-foreground">
              The information provided on Hyper Dash is for informational purposes only and should not be considered
